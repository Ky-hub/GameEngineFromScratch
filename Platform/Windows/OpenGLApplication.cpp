...
int My::OpenGLApplication::Initialize()
{
	...
	if (GLAD_WGL_ARB_pixel_format && GLAD_WGL_ARB_multisample && GLAD_WGL_ARB_create_context)
	{
		...
		const int attributes[] = {
			...
			WGL_RED_BITS_ARB,		static_cast<int>(m_Config.redBits),
			WGL_GREEN_BITS_ARB,		static_cast<int>(m_Config.greenBits),
			WGL_BLUE_BITS_ARB,		static_cast<int>(m_Config.blueBits),
			WGL_ALPHA_BITS_ARB,		static_cast<int>(m_Config.alphaBits),
			WGL_DEPTH_BITS_ARB,     static_cast<int>(m_Config.depthBits),
			WGL_STENCIL_BITS_ARB,   static_cast<int>(m_Config.stencilBits),
